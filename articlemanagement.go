...
func main() {
	Articles = []Article{
		Article{Id: "1", Name: "sandhiya", Bio: "Trainee", Position: "Golang"},
		Article{Id: "2", Name: "sudeep", Bio: "Unknown", Position: "Nothing"},
		Article{Id: "3", Name: "tanty", Bio: "Dog", Position: "Pet1"},
		Article{Id: "4", Name: "lucky", Bio: "Dog", Position: "Pet2"},
